                    ...
                    <div class="col-xs-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-bordered" method="POST" action='{{ URL("admin/brand") }}' enctype="multipart/form-data">
                                @csrf
                                @if ($errors->any())
                                ...
                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                        <input type="text" autocomplete="off" class="form-control" name="brand"   value="{{ old('brand') }}"  required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Brand Image</label>
                                        <div class="col-md-6">
                                            <input type="file" class="form-control" name="brandimage" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <a href='{{ url("admin/brand") }}'  class="btn btn-primary col-md-1" name="Cancel" >Cancel</a>
                                    </div>  
                                </form>
                            </div>
                        </section>

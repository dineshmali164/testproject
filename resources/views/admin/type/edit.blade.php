                    ...
                    <div class="col-xs-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-bordered" method="POST" action='{{ URL("admin/type/$type->id") }}' enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                @if ($errors->any())
                                ...
                                @endif
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control populate" name="category" id="category" >
                                                ...
                                                @foreach($categories as $cat)
                                                    <option value="{{ $cat->id }}" <?php if( $cat->id == $type->category){ echo "selected"; } ?> >{{ $cat->category }}</option>
                                                @endforeach
                                             </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control populate" id="subcategory_records" name="subcategory" >
                                                ...
                                                @foreach($subcategories as $subcat)
                                                    <option value="{{ $subcat->id }}" <?php if( $subcat->id == $type->subcategory){ echo "selected"; } ?>>{{ $subcat->subcategory }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control populate" id="subsubcategory" name="subsubcategory" >
                                                ...
                                                @foreach($subsubcategories as $subsubcat)
                                                    <option value="{{ $subsubcat->id }}" <?php if($subsubcat->id == $type->subsubcategory){ echo "selected"; } ?>>{{ $subsubcat->subsubcategory }}</option>	
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                        <input type="text" autocomplete="off" class="form-control" name="type"   value="{{ $type->type }}"  required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">type Image</label>
                                        <div class="col-md-6">
                                            <input type="file" class="form-control" name="typeimage" >
                                            <img src='{{ url("type/$type->typeimage") }}' width="100"> 
                                        </div>
                                    </div>
                                    <div class="form-group">

        ...
        <div class="container">
            <div class="content-top">
                <div class="col-md-6 col-md">
                    ...
                    <a href="single.html" class="b-link-stroke b-animate-go  thickbox">
                        <img src="{{ asset('asset_front/images/pi.jpg') }}" class="img-responsive" alt=""/>
                ...
                <div class="col-md-6 col-md1">
                    <div class="col-3">
                    <a href="single.html">
                        <img src="{{ asset('asset_front/images/pi1.jpg') }}" class="img-responsive" alt="">
                        <div class="col-pic">
                            <p>Lorem Ipsum</p>
                            <label></label>
                            <h5>For Men</h5>
                    ...
                    <div class="col-3">
                    <a href="single.html">
                        <img src="{{ asset('asset_front/images/pi2.jpg') }}" class="img-responsive" alt="">
                        <div class="col-pic">
                            <p>Lorem Ipsum</p>
                            <label></label>
                            <h5>For Kids</h5>
                    ...
                    <div class="col-3">
                    <a href="single.html">
                        <img src="{{ asset('asset_front/images/pi3.jpg') }}" class="img-responsive" alt="">
                        <div class="col-pic">
                            <p>Lorem Ipsum</p>
                            <label></label>
                            <h5>For Women</h5>
            ...
            <div class="content-mid">
                ...
                <div class="mid-popular">
                    ...
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="{{ asset('asset_front/images/pc.jpg') }}" class="img-responsive" alt="">
                            <div class="zoom-icon ">
                    ...
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="{{ asset('asset_front/images/pc1.jpg') }}" class="img-responsive" alt="">
                            <div class="zoom-icon ">
                        ...
                        <div class="mid-1">
                            <div class="women">
                                ...
                                <div class="img item_add">
                                <a href="#"><img src="{{ asset('asset_front/images/ca.png') }}" alt=""></a>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="mid-2">
                    ...
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="{{ asset('asset_front/images/pc2.jpg') }}" class="img-responsive" alt="">
                            <div class="zoom-icon ">
                    ...
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="{{ asset('asset_front/images/pc3.jpg') }}" class="img-responsive" alt="">
                            <div class="zoom-icon ">
                ...
                <div class="mid-popular">
                    ...
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="{{ asset('asset_front/images/pc4.jpg') }}" class="img-responsive" alt="">
                            <div class="zoom-icon ">
                    ...
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="{{ asset('asset_front/images/pc5.jpg') }}" class="img-responsive" alt="">
                            <div class="zoom-icon ">
                    ...
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="{{ asset('asset_front/images/pc6.jpg') }}" class="img-responsive" alt="">
                            <div class="zoom-icon ">
                    ...
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="{{ asset('asset_front/images/pc7.jpg') }}" class="img-responsive" alt="">
                            <div class="zoom-icon ">
            ...
            <div class="brand">
                <div class="col-md-3 brand-grid">
                    <img src="{{ asset('asset_front/images/ic.png') }}" class="img-responsive" alt="">
                </div>
                <div class="col-md-3 brand-grid">
                    <img src="{{ asset('asset_front/images/ic1.png') }}" class="img-responsive" alt="">
                </div>
                <div class="col-md-3 brand-grid">
                    <img src="{{ asset('asset_front/images/ic2.png') }}" class="img-responsive" alt="">
                </div>
                <div class="col-md-3 brand-grid">
                    <img src="{{ asset('asset_front/images/ic3.png') }}" class="img-responsive" alt="">
                </div>
                <div class="clearfix"></div>
            </div>
            <!--//brand-->
